...
from pretraining.data.elastic_deform import (
...
class FileCache(BaseTransform):
    ...
    def __init__(
        ...
        string.
        @auto_dir: If `True`, the cache directory will be determined based on the
        ...
        if self.auto_dir:
            ...
            config_str = json.dumps(
                self._hashable_config(), default=str, sort_keys=True
            )
