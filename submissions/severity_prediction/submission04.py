### Submission 04: multitask (full) pretraining with cross validation; rotOrProb = 0.0
# FinalSeverityCV_balce-multitaskECCVFull_lrDecayUntil0_initModefull_rotProb0.0_AugModeall_cv_convnext_20220626-180738
...
inference_checkpoint = os.path.join(inference_checkpoint_dir, "sev4.pt")
...
def train():
    ...
    prenick = 'SeverityPrediction/Submission04'
    cv_enabeled = True
    rotationProb = 0.0
    pretraining = 'multitaskECCVFull'
...
def pretrain():
    ...
    args = {
        'gpu': '0',
        'nick': 'SeverityPrediction/pretrainingSubmission04',
        'mode': 3,
        'load': False,
        'imsize': '256',
        'model': 'multinext'
...
def inference():
    args = {
        ...
        'output': 'output_sev_submission04.csv',
    }
    args = namedtuple("args", args.keys())(*args.values())
    logging.getLogger().setLevel(logging.INFO)
