### Submission 02: segmentation (full) pretraining with cross validation; rotOrProb = 0.0
...
inference_checkpoint = os.path.join(inference_checkpoint_dir, "sev2.pt")
...
def train():
    ...
    prenick = 'SeverityPrediction/Submission02'
    cv_enabeled = True
    rotationProb = 0.0
...
def pretrain():
    ...
    args = {
        'gpu': '0',
        'nick': 'SeverityPrediction/pretrainingSubmission02',
        'mode': 1,
        'load': False,
        'imsize': '256',
        'model': 'multinext'
...
def inference():
    args = {
        ...
        'output': 'output_sev_submission02.csv',
    }
    args = namedtuple("args", args.keys())(*args.values())
    logging.getLogger().setLevel(logging.INFO)
