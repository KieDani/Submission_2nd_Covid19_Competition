### Submission 03: segmmia (full) pretraining with cross validation; rotOrProb = 0.0
...
inference_checkpoint = os.path.join(inference_checkpoint_dir, "sev3.pt")
...
def train():
    ...
    prenick = 'SeverityPrediction/Submission03'
    cv_enabeled = True
    rotationProb = 0.0
    pretraining = 'segmiaECCVFull'
...
def pretrain():
    ...
    args = {
        'gpu': '0',
        'nick': 'SeverityPrediction/pretrainingSubmission03',
        'mode': 1,
        'load': False,
        'imsize': '256',
        'model': 'multinext'
...
def inference():
    args = {
        ...
        'output': 'output_sev_submission03.csv',
    }
    args = namedtuple("args", args.keys())(*args.values())
    logging.getLogger().setLevel(logging.INFO)
