### Submission 05: segmentation (2G) pretraining without cross validation; rotOrProb = 0.0
...
inference_checkpoint = os.path.join(inference_checkpoint_dir, "det5")
...
def train():
    ...
    prenick = 'InfectionDetection/Submission05'
    cv_enabeled = False
    rotationProb = 0.0
...
def pretrain():
    ...
    args = {
        'gpu': '0',
        'nick': 'InfectionDetection/pretrainingSubmission05',
        'mode': 1,
        'load': False,
        'imsize': '256',
        'model': 'multinext'
...
def inference():
    args = {
        ...
        'output': 'output_det_submission05.csv',
    }
    args = namedtuple("args", args.keys())(*args.values())
    logging.getLogger().setLevel(logging.INFO)
