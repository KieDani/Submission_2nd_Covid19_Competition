### Submission 04: segmia (2G) pretraining without cross validation; rotOrProb = 0.25
...
inference_checkpoint = os.path.join(inference_checkpoint_dir, "det4")
...
def train():
    ...
    prenick = 'InfectionDetection/Submission04'
    cv_enabeled = False
    rotationProb = 0.25
...
def pretrain():
    ...
    args = {
        'gpu': '0',
        'nick': 'InfectionDetection/pretrainingSubmission04',
        'mode': 1,
        'load': False,
        'imsize': '256',
        'model': 'multinext'
...
def inference():
    args = {
        ...
        'output': 'output_det_submission04.csv',
    }
    args = namedtuple("args", args.keys())(*args.values())
    logging.getLogger().setLevel(logging.INFO)
