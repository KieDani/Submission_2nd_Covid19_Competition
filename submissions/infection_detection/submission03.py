### Submission 03: segmia (2G) pretraining with cross validation; rotOrProb = 0.0
...
from paths import DATA_PATH, inference_checkpoint_dir, pretraining_LOGS_PATH
inference_checkpoint = os.path.join(inference_checkpoint_dir, "det3")
...
def train():
    ...
    prenick = 'InfectionDetection/Submission03'
    cv_enabeled = True
    rotationProb = 0.
    pretraining = 'segmiaECCV'
...
def pretrain():
    ...
    args = {
        'gpu': '0',
        'nick': 'InfectionDetection/pretrainingSubmission03',
        'mode': 1,
        'load': False,
        'imsize': '256',
        'model': 'multinext'
...
def inference():
    args = {
        ...
        'output': 'output_det_submission03.csv',
    }
    args = namedtuple("args", args.keys())(*args.values())
    logging.getLogger().setLevel(logging.INFO)
